...
export function CollapsedGroupPreview({ group, cmpsOrder }) {
	return (
		<section className="collapsed-group-preview">
			...
			<CollapsedGroupSummary group={group} cmpsOrder={cmpsOrder} />
		</section>
	)
}
...
export function CollapsedGroupSummary({ group, cmpsOrder }){
	...
	return (
		<section className="group-summary full">
			{/* <section style={{ width: 400 + 'px', height: '42px' }} className="white-space"></section> */}
